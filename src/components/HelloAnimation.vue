        ...
        setup(){
            ...
            return function(){
                return h2({
                    ...
                    !state.intersected ? Intersection({
                        once: true
                    },{
                        ...
                        div({
                            ...
                            onVnodeMounted:()=>{
                                ...
                                const setGreeting = async (index: number) => {
                                    ...
                                    state.isRtL = greeting[index] == 'مرحبا' || greeting[index] == 'שלום';

                                    const splitGreeting =
                                        greeting[index].split('')
                                    ...
                                    for(let i = state.currentGreeting.length; i < (splitGreeting.length * 2) - 1; i++){
                                    ...
                                    if(state.currentGreetingIndex < greeting.length - 1){
                                        state.currentGreetingIndex = state.currentGreetingIndex+1;
                                    }else {
                            ...
                            span({class:['ticker gradient-text',{'fade-appear':state.addTickEffect}]},['|'])
                        ])
                    :   null,
